 ...
 * BITAGORA NODE
 * polls.js
 * Entrypoint for Polls Transaction Processor in Bitagora Platform voting system
 ...
 */
 ...
 const { PollsHandler } = require('./polls-handler');
 ...
 transactionProcessor.addHandler(new PollsHandler());
